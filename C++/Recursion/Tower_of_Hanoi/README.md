![Tower of Hanoi](/Images/Recursion/Tower_of_Hanoi.svg)
...
template<class T, std::enable_if_t<std::is_integral_v<T>, int> = 0>
void test_func(T num)
{
	cust::recursive_version::hanoi_game     h1 {};
	cust::non_recursive_version::hanoi_game h2 {};
	cust::iterative::hanoi_game             h3 {};

	for (T n { 0 }; n <= num; ++n)
	{
		std::cout << "move " << n << " disks:\n\n";
